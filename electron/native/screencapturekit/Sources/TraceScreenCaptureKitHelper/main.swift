...
final class ScreenCaptureRecorder: NSObject, SCStreamOutput, SCStreamDelegate {
	...
	private let sampleQueue = DispatchQueue(label: "app.trace.sck-helper.samples")
	private let stateQueue = DispatchQueue(label: "app.trace.sck-helper.state")
...
@main
struct TraceScreenCaptureKitHelper {
