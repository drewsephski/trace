			...
			<div className="space-y-4">
				<div className="flex gap-4">
					<div className="flex-1">
						<label className="block text-sm font-medium text-slate-700 mb-2">Sample Feedback</label>
						<textarea
					...
					<div className="flex-1">
						<label className="block text-sm font-medium text-slate-700 mb-2">Generated Code</label>
