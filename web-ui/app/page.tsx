...
import { CreditCard, Lock, Moon } from "lucide-react";
...
export default function LandingPage() {
	...
	const _sectionProgressValues = useSectionProgressValues(workflowSections.length);

	const router = useRouter();

	const [_dashboardRef, _inView] = useInView({
		triggerOnce: true,
		threshold: 0.1,
	});
