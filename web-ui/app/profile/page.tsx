					...
					{error ? (
						...
						<div className="space-y-2">
							<p>
								...
								<span
									className={`${subscription.status === "active" ? "text-green-500" : "text-yellow-500"}`}
								>
							...
							{subscription.status === "canceled" ? (
								...
								<div className="mt-4 flex flex-wrap gap-3">
									...
									<button
										...
										className="bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded-lg disabled:opacity-60"
									>
						...
						<div className="mt-4 space-y-4">
							...
							<Link
								href="/pay?plan=enterprise"
								className="inline-flex items-center justify-center rounded-full bg-primary px-6 py-3 text-white shadow-subtle hover:bg-primary-dark hover:shadow-hover transition-all"
							>
								View Plans
							</Link>
						</div>
					...
					<div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
						<div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full">
							...
							<p className="text-gray-600 dark:text-gray-300 mb-6">
								...
								{new Date(subscription?.current_period_end || "").toLocaleDateString()}. No refunds
								are provided for cancellations.
							</p>
