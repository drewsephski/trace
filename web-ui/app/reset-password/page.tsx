...
function ResetPasswordContent() {
	...
	}, [email, success, isLoading, handleResetPassword]); // eslint-disable-line react-hooks/exhaustive-deps
			...
			<div className="max-w-md w-full space-y-8">
				...
				{error && (
					<div className="bg-red-50 dark:bg-red-900/30 text-red-500 p-4 rounded-lg">
						{error}
						<button onClick={handleResetPassword} className="ml-2 underline hover:text-red-600">
							Try again
						</button>
					</div>
				)}
